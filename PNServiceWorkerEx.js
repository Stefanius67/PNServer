 ...
 * @param {ExtendableEvent} event 
 */
async function pnSubscribeEx(event) {
...
async function pnSaveSubscription(sub) {
	...
	console.log('Subscribe for user-id: ', self.userID);
    var fetchdata = {
            method: 'post',
...
// ... and listen to the clicklUserID
...
self.addEventListener('message', pnSubscribeEx);
